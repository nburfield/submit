class SubmissionsController < ApplicationController
  ...
  def run
    ...
    @details = { :course => get_course.name, :assignmentname => @submission.assignment.name, :id => assignment.id, :sid => @submission.id, :username => current_user.name, :userid =>current_user.id, :cputime => assignment.test_case.cpu_time, :coresize => assignment.test_case.core_size }
